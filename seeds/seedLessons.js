...
const lessonData = [
    ...
    },
    {
        ...
        category_id: 2, // week 1
        body1:`<h3>Common Threaded Fastener Drive Types
            <h4>Sriving Fasteners</h4>
            <p>When engaging/mating threaded parts, the action of rotating the threaded fastener into place is referred to as <em>driving</em> the fastener. This is how tools like the Screwdriver and impact driver got their names. Another much less common name for wrenches would be bolt or nut drivers.</p>
            <h4>Hex Drive</h4>
        ...
        body2:`<h4>Slotted</h4>
            ...
            <h4>Philips</h4>
            <p>This is becoming the most popular head type for screws as it does self-center the driver head. Phillips head screws are recognized by their plus (+) shape and are measured in 5 sizes ( from smallest to largest: #0, #1, #2, #3, & #4 | not including jeweler sizes) The main downside of this drive type is that it strips fairly easily if mis-handled and it can have problems with “camming out”.</p>
            <h4>Square</h4>
            <p>Sometimes referred to as a “Robinson drive” these are not very common. When driving a square drive fastener (male or female) this design is <em>extremely</em> resistant to stripping out. Size is the distance of 1 side of the square.</p>,
            <h4>Torx</h4>
    ...
    },
    {
        ...
        body3: `<h4>Combination</h4>
            <p>The most popular basic wrench you will  nd in any store-bought “mechanic's tool set”. The Combination Wrench (or Combo Wrench) has a box end on one side and an open end on the other. The tool sets you buy will usually have 12-points on the box side of the combo wrenches.</p>`,
    ...
    },
    {
        ...
        fig_caption2: 'Here you can see how turning the worm gear opens and closes the jaws of the tool.',
